...
namespace DiFfRG
{
  ...
  public:
    ...
    // clang-format off
static KOKKOS_FORCEINLINE_FUNCTION auto kernel(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k, const double& Nf, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA3, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAcbc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA4, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAqbq1, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Mq)
{
...
1.333333333333333 * powr<2>(p)))) +
0.163265306122449 * powr<-1>(l1) * Nf *powr<-4>(p) *
ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - cosl1p1 * l1 * p + powr<2>(p))) *
ZAqbq1(0.816496580927726 *
sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
ZAqbq1(0.3333333333333333 *
sqrt(6. * powr<2>(l1) - 6. * (2. * cosl1p1 + cosl1p2) * l1 * p + 10. * powr<2>(p))) *
ZAqbq1(0.3333333333333333 *
sqrt(6. * powr<2>(l1) - 6. * (2. * cosl1p1 + 2. * cosl1p2 + cosl1p3) * l1 * p +
10. * powr<2>(p))) *
...
powr<-1>(powr<2>(Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) +
powr<2>(RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
powr<2>(Zq(k)) +
2. * sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
RF(powr<2>(k),
powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
Zq(k) *
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) +
(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
powr<2>(Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))))) *
powr<-1>(3. * powr<2>(Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
3. *
powr<2>(RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
powr<2>(Zq(k)) +
3.464101615137754 *
sqrt(3. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2) * l1 * p + 4. * powr<2>(p)) *
RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)) *
Zq(k) *
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) +
(3. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2) * l1 * p + 4. * powr<2>(p)) *
powr<2>(Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) *
(196. * l1 * powr<4>(p) * Mq(l1) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) +
38. * powr<2>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
3. * cosl1p3 * l1 * powr<5>(p) * powr<2>(Mq(l1)) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
38. * powr<2>(l1) * powr<4>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) +
sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
3. * cosl1p3 * l1 * powr<5>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) -
38. * powr<2>(l1) * powr<4>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
powr<2>(Mq(l1)) * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
(RF(powr<2>(k),
powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
Zq(k) +
sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) -
51. * powr<2>(cosl1p3) * powr<2>(l1) * powr<4>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
powr<2>(Mq(l1)) * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) -
66. * powr<2>(cosl1p3) * powr<3>(l1) * powr<4>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(l1) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) +
120. * cosl1p3 * powr<2>(l1) * powr<5>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(l1) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) -
60. * l1 * powr<6>(p) * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(l1) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) +
3. * powr<2>(cosl1p2) * powr<2>(l1) * powr<2>(p) *
(powr<2>(p) *
(powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(22. *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
(RF(powr<2>(k), powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)) *
Zq(k) +
sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)) *
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)))) +
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
(Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
(-12. *
sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p +
powr<2>(p))) *
RF(powr<2>(k),
powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
12. *
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
7. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))))) +
2. * l1 * Mq(l1) * (RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-7. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
12. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
...
1.333333333333333 * powr<2>(p))))) +
powr<2>(Mq(l1)) *
(12. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
6. * powr<2>(l1) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
37. * powr<2>(p) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) +
18. * powr<2>(cosl1p3) * powr<2>(l1) * powr<2>(p) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))))) -
l1 * Mq(l1) * (RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(45. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
31. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
34. * powr<2>(l1) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
5. * Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
19. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
2. * (cosl1p1 + cosl1p2) * l1 * p +
...
1.333333333333333 * powr<2>(p)))))) +
2. * l1 * Mq(l1) * (RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-19. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
5. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
...
1.333333333333333 * powr<2>(p))))) +
powr<2>(Mq(l1)) *
(5. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
47. * powr<2>(p) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
3. * cosl1p2 * l1 * p *
(powr<2>(p) *
(-3. * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(13. *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
...
powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
4. * Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p +
powr<2>(p)))) +
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2) * l1 * p +
...
powr<2>(p))) *
RF(powr<2>(k),
powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) +
30. * powr<2>(cosl1p3) * powr<2>(l1) * powr<2>(p) *
(powr<2>(Mq(l1)) -
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) +
216. * powr<3>(cosl1p2) * powr<3>(l1) * powr<3>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
162. * powr<3>(cosl1p3) * powr<3>(l1) * powr<3>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
3. * powr<2>(cosl1p2) * powr<2>(l1) * (60. * cosl1p3 * l1 - 29. * p) * powr<3>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
24. * powr<2>(cosl1p3) * powr<2>(l1) * powr<4>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
12. *
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
11. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
2. * (cosl1p1 + cosl1p2) * l1 * p +
...
1.333333333333333 * powr<2>(p)))))) +
2. * l1 * Mq(l1) * (RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-3. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
53. * powr<2>(p) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
3. * Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) +
14. * Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) -
2. * (cosl1p1 + cosl1p2) * l1 * p +
...
1.333333333333333 * powr<2>(p)))))) +
2. * l1 * Mq(l1) * (RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(30. * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) -
2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
64. * powr<2>(l1) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
2. * powr<2>(p) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) -
54. * powr<3>(cosl1p3) * powr<3>(l1) * powr<3>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
63. * powr<2>(cosl1p3) * powr<2>(l1) * powr<4>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) +
3. * powr<2>(cosl1p1) * powr<2>(l1) * powr<2>(p) *
(powr<2>(p) *
(-30. * l1 * sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
Mq(l1) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
14. * powr<2>(l1) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
64. * powr<2>(p) * powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) +
18. * powr<2>(cosl1p2) * powr<2>(l1) * powr<2>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
36. * powr<2>(cosl1p3) * powr<2>(l1) * powr<2>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
3. * cosl1p2 * l1 * powr<2>(p) * (10. * cosl1p3 * l1 + 7. * p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))))) -
8. * powr<2>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
45. * powr<2>(cosl1p3) * powr<2>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
14. * cosl1p3 * l1 * powr<5>(p) * powr<2>(Mq(l1)) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
62. * cosl1p3 * powr<2>(l1) * powr<5>(p) * Mq(l1) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
38. * powr<4>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)) *
Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
42. * powr<2>(cosl1p3) * powr<4>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
54. * powr<4>(cosl1p3) * powr<4>(l1) * powr<4>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
72. * cosl1p3 * powr<3>(l1) * powr<5>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
81. * powr<3>(cosl1p3) * powr<3>(l1) * powr<5>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
48. * powr<2>(l1) * powr<6>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
60. * powr<2>(cosl1p3) * powr<2>(l1) * powr<6>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
2. * cosl1p3 * l1 * powr<7>(p) * powr<2>(Mq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
42. * powr<2>(cosl1p3) * powr<4>(l1) * powr<4>(p) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
54. * powr<4>(cosl1p3) * powr<4>(l1) * powr<4>(p) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
81. * powr<3>(cosl1p3) * powr<3>(l1) * powr<5>(p) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
60. * powr<2>(cosl1p3) * powr<2>(l1) * powr<6>(p) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
54. * powr<4>(cosl1p1) * powr<4>(l1) * powr<4>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
108. * powr<4>(cosl1p2) * powr<4>(l1) * powr<4>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
18. * powr<3>(cosl1p2) * powr<3>(l1) * (12. * cosl1p3 * l1 - 7. * p) * powr<4>(p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
3. * powr<3>(cosl1p1) * powr<3>(l1) * powr<4>(p) *
(18. * cosl1p2 * l1 + 54. * cosl1p3 * l1 + 7. * p) *
(powr<2>(Mq(l1)) - powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1))) *
(-sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) -
Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
8. * powr<2>(l1) * powr<4>(p) *
sqrt(powr<-1>(3. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2) * l1 * p +
4. * powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
powr<2>(RF(powr<2>(k), powr<2>(l1)) * Zq(k) + l1 * Zq(l1)) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) -
45. * powr<2>(cosl1p3) * powr<2>(l1) * powr<4>(p) *
sqrt(powr<-1>(3. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2) * l1 * p +
4. * powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) *
Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + powr<2>(p))) *
...
Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p +
1.333333333333333 * powr<2>(p)))) +
102. * powr<2>(cosl1p3) * powr<3>(l1) * powr<4>(p) *
sqrt(powr<-1>(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2 + cosl1p3) * l1 * p +
powr<2>(p))) *
sqrt(powr<-1>(3. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2) * l1 * p +
4. * powr<2>(p))) *
...
powr<-1>(fma(_interp4, _interp7, fma(_cse34, _interp8, 0.)));
      ...
      { // subkernel 6
        ...
        const auto _interp38 =
          ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (2. * cosl1p1 + cosl1p2) * l1 * p + 10. * powr<2>(p)));
        const auto _interp39 =
          ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (2. * (cosl1p1 + cosl1p2) + cosl1p3) * l1 * p + 10. * powr<2>(p)));
        ...
        const auto _cse5 = cosl1p1 + cosl1p2 + cosl1p3;
        const auto _cse6 = -2. * _cse5 * l1 * p;
        const auto _cse7 = _cse1 + _cse3 + _cse6;
        const auto _cse8 = powr<2>(_interp41);
        const auto _cse9 = 3. * _cse1;
        const auto _cse10 = cosl1p1 + cosl1p2;
        const auto _cse11 = -6. * _cse10 * l1 * p;
        const auto _cse12 = 4. * _cse3;
        const auto _cse13 = _cse11 + _cse12 + _cse9;
        const auto _cse14 = powr<2>(_interp45);
        const auto _cse15 = -_interp49;
        const auto _cse16 = sqrt(powr<-1>(_cse4));
        const auto _cse17 = -_cse16 * _interp41 * _interp48;
        const auto _cse18 = _cse15 + _cse17;
        const auto _cse19 = powr<2>(_cse3);
        const auto _cse20 = sqrt(_cse7);
        const auto _cse21 = sqrt(powr<-1>(_cse7));
        const auto _cse22 = _cse20 * _interp52;
        const auto _cse23 = _interp41 * _interp51;
        const auto _cse24 = _cse22 + _cse23;
        const auto _cse25 = powr<5>(p);
        const auto _cse26 = powr<2>(cosl1p3);
        const auto _cse27 = -_interp55;
        const auto _cse28 = -2. * _cse10 * l1 * p;
        const auto _cse29 = 1.333333333333333 * _cse3;
        const auto _cse30 = _cse1 + _cse28 + _cse29;
        const auto _cse31 = sqrt(powr<-1>(_cse30)); // clang-format off
_acc += 0.163265306122449 * powr<-2>(_cse3) * _interp36 * _interp37 * _interp38 * _interp39 * powr<-1>(l1) * powr<-2>(_cse14 + powr<2>(_interp41 * _interp42 + _interp46 * l1)) * Nf * fma(-38., _cse1 * _cse14 * _cse19 * _cse21 * _cse24 * _interp47 * _interp53, fma(-51., _cse1 * _cse14 * _cse19 * _cse21 * _cse24 * _cse26 * _interp47 * _interp53, fma(38., _cse1 * _cse14 * _cse18 * _cse19 * _interp50 * _interp53, fma(-8., _cse1 * _cse14 * _cse19 * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54), fma(-45., _cse1 * _cse14 * _cse19 * _cse26 * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54), fma(38., powr<2>(_cse1) * _cse14 * _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54), fma(42., powr<2>(_cse1) * _cse14 * _cse18 * _cse19 * _cse26 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54), fma(-54., powr<2>(_cse1) * _cse14 * _cse18 * _cse19 * powr<2>(_cse26) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54), fma(-48., _cse1 * _cse14 * _cse18 * powr<3>(_cse3) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54), fma(60., _cse1 * _cse14 * _cse18 * _cse26 * powr<3>(_cse3) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54), fma(99., _cse14 * _cse21 * _cse24 * _cse25 * _interp47 * _interp53 * cosl1p3 * l1, fma(3., _cse14 * _cse18 * _cse25 * _interp50 * _interp53 * cosl1p3 * l1, fma(-14., _cse14 * _cse25 * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * l1, fma(-72., _cse14 * _cse18 * _cse25 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * powr<3>(l1), fma(81., _cse14 * _cse18 * _cse25 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p3) * powr<3>(l1), fma(120., _cse1 * _cse16 * _cse21 * _cse24 * _cse25 * _interp45 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 * cosl1p3 * (_interp41 * _interp42 + _interp46 * l1), fma(-62., _cse1 * _cse18 * _cse25 * _interp45 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * (_interp41 * _interp42 + _interp46 * l1), fma(6., _cse1 * sqrt(powr<-1>(_cse13)) * _cse21 * _cse24 * _cse25 * _interp45 * _interp47 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * cosl1p3 * (_interp41 * _interp42 + _interp46 * l1), fma(-60., _cse16 * _cse21 * _cse24 * powr<3>(_cse3) * _interp45 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 * l1 * (_interp41 * _interp42 + _interp46 * l1), fma(196., _cse19 * _interp45 * _interp47 * _interp50 * _interp53 * l1 * (_interp41 * _interp42 + _interp46 * l1), fma(-16., _cse16 * _cse19 * _cse21 * _cse24 * _interp45 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 * powr<3>(l1) * (_interp41 * _interp42 + _interp46 * l1), fma(-66., _cse16 * _cse19 * _cse21 * _cse24 * _cse26 * _interp45 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 * powr<3>(l1) * (_interp41 * _interp42 + _interp46 * l1), fma(76., _cse18 * _cse19 * _interp45 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(l1) * (_interp41 * _interp42 + _interp46 * l1), fma(76., sqrt(powr<-1>(_cse13)) * _cse19 * _cse21 * _cse24 * _interp45 * _interp47 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * powr<3>(l1) * (_interp41 * _interp42 + _interp46 * l1), fma(102., sqrt(powr<-1>(_cse13)) * _cse19 * _cse21 * _cse24 * _cse26 * _interp45 * _interp47 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * powr<3>(l1) * (_interp41 * _interp42 + _interp46 * l1), fma(38., _cse1 * _cse19 * _cse21 * _cse24 * _interp47 * _interp53 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(51., _cse1 * _cse19 * _cse21 * _cse24 * _cse26 * _interp47 * _interp53 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(38., _cse1 * _cse16 * _cse19 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp50 * _interp53 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-38., powr<2>(_cse1) * _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-42., powr<2>(_cse1) * _cse18 * _cse19 * _cse26 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(54., powr<2>(_cse1) * _cse18 * _cse19 * powr<2>(_cse26) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(48., _cse1 * _cse18 * powr<3>(_cse3) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-60., _cse1 * _cse18 * _cse26 * powr<3>(_cse3) * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-8., _cse1 * sqrt(powr<-1>(_cse13)) * _cse19 * _interp47 * _interp50 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-45., _cse1 * sqrt(powr<-1>(_cse13)) * _cse19 * _cse26 * _interp47 * _interp50 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-99., _cse21 * _cse24 * _cse25 * _interp47 * _interp53 * cosl1p3 * l1 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(3., _cse16 * _cse25 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp50 * _interp53 * cosl1p3 * l1 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-14., sqrt(powr<-1>(_cse13)) * _cse25 * _interp47 * _interp50 * (1.732050807568877 * _interp41 * _interp54 + sqrt(_cse13) * _interp55) * cosl1p3 * l1 * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(72., _cse18 * _cse25 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * powr<3>(l1) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-81., _cse18 * _cse25 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p3) * powr<3>(l1) * powr<2>(_interp41 * _interp42 + _interp46 * l1), fma(-54., powr<2>(_cse1) * _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<4>(cosl1p1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)), fma(108., powr<2>(_cse1) * _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<4>(cosl1p2) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)), fma(18., _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p2) * powr<3>(l1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * (12. * cosl1p3 * l1 - 7. * p), fma(-2., _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * l1 * powr<7>(p), fma(2., _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * l1 * powr<2>(_interp41 * _interp42 + _interp46 * l1) * powr<7>(p), fma(-3., _cse18 * _cse19 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p1) * powr<3>(l1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * (18. * cosl1p2 * l1 + 54. * cosl1p3 * l1 + 7. * p), fma(3., _cse1 * _cse3 * powr<2>(cosl1p2) * (18. * _cse1 * _cse18 * _cse26 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) + _cse3 * (-6. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + _cse14 * (-22. * _cse21 * _cse24 * _interp47 * _interp53 + 12. * _cse16 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp50 * _interp53 - 7. * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 37. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) + 2. * _interp45 * (-7. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 + 22. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 12. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) + 6. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 37. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) + (22. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * ((-12. * _cse16 * _interp41 * _interp48 - 12. * _interp49) * _interp53 + 7. * _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) - 51. * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * l1 * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p)), fma(cosl1p2, l1 * p * (63. * _cse1 * _cse18 * _cse19 * _cse26 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) + _cse19 * (-64. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + _cse14 * (99. * _cse21 * _cse24 * _interp47 * _interp53 + 3. * _cse18 * _interp50 * _interp53 + 14. * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 2. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) + 2. * _interp45 * (30. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 - 65. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 31. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) + 64. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 2. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - (99. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * ((-3. * _cse16 * _interp41 * _interp48 - 3. * _interp49) * _interp53 + 14. * _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) - 54. * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p3) * powr<3>(l1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p) + 3. * cosl1p3 * l1 * (-6. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + _cse14 * (-39. * _cse21 * _cse24 * _interp47 * _interp53 + 12. * _cse16 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp50 * _interp53 - 11. * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 53. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) + 2. * _interp45 * (-3. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 + 5. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 12. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) + 6. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 53. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) + (39. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * ((-12. * _cse16 * _interp41 * _interp48 - 12. * _interp49) * _interp53 + 11. * _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p)), fma(3., _cse1 * _cse3 * powr<2>(cosl1p1) * (-36. * _cse1 * _cse18 * _cse26 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) + 18. * _cse1 * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(cosl1p2) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) + _cse3 * (14. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + _cse14 * (-17. * _cse21 * _cse24 * _interp47 * _interp53 + 17. * _cse18 * _interp50 * _interp53 - 11. * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 64. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) - 30. * _cse16 * _cse21 * _cse24 * _interp45 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 * l1 * (_interp41 * _interp42 + _interp46 * l1) - 14. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 64. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) + (17. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * (17. * (_cse16 * _interp41 * _interp48 + _interp49) * _interp53 + 11. * _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) - 3. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p2 * l1 * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * (10. * cosl1p3 * l1 + 7. * p)), fma(cosl1p1, l1 * p * (-24. * _cse1 * _cse18 * _cse19 * _cse26 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) - 4. * _cse19 * (-24. * _cse14 * (_cse21 * _cse24 * _interp47 + (_cse16 * _interp41 * _interp48 + _interp49) * _interp50) * _interp53 + 34. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) - _interp45 * (45. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 - 31. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 31. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) + 24. * (_cse21 * _cse24 * _interp47 + (_cse16 * _interp41 * _interp48 + _interp49) * _interp50) * _interp53 * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 34. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) + 216. * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p2) * powr<3>(l1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p) - 162. * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<3>(cosl1p3) * powr<3>(l1) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p) + 3. * cosl1p3 * l1 * (34. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + _cse14 * (-46. * _cse21 * _cse24 * _interp47 * _interp53 + 5. * _cse16 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp50 * _interp53 - 19. * _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 47. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) + 2. * _interp45 * (-19. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 + 12. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 5. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) - 34. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 47. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) + (46. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * ((-5. * _cse16 * _interp41 * _interp48 - 5. * _interp49) * _interp53 + 19. * _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p) + 3. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(cosl1p2) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * (60. * cosl1p3 * l1 - 29. * p) * powr<3>(p) - 3. * cosl1p2 * l1 * p * (30. * _cse1 * _cse18 * _cse26 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) + _cse3 * (6. * _cse1 * _cse14 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) + 3. * _cse14 * (13. * _cse21 * _cse24 * _interp47 * _interp53 + 4. * _cse18 * _interp50 * _interp53 + _interp47 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) - 27. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) + 2. * _interp45 * (11. * _cse16 * _cse21 * _cse24 * (_interp41 * _interp48 + sqrt(_cse4) * _interp49) * _interp53 - 5. * _cse18 * _interp50 * (_cse27 - _cse31 * _interp41 * _interp54) + 12. * _interp47 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54)) * l1 * (_interp41 * _interp42 + _interp46 * l1) - 6. * _cse1 * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) + 81. * _cse18 * _cse3 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * powr<2>(_interp41 * _interp42 + _interp46 * l1) - 3. * (13. * _cse21 * _cse24 * _interp47 * _interp53 + _interp50 * ((-4. * _cse16 * _interp41 * _interp48 - 4. * _interp49) * _interp53 + _interp47 * (_cse27 - _cse31 * _interp41 * _interp54))) * powr<2>(_interp41 * _interp42 + _interp46 * l1)) + 22. * _cse18 * (-_cse21 * _interp41 * _interp51 - _interp52) * (_cse27 - _cse31 * _interp41 * _interp54) * cosl1p3 * l1 * (_cse14 - powr<2>(_interp41 * _interp42 + _interp46 * l1)) * powr<3>(p))), 0.)))))))))))))))))))))))))))))))))))))))))))))))))) * fma(-1., _interp40 * _interp41, fma(-1., _interp42 * (-50. * _interp41 + _interp43 + 50. * _interp44), 0.)) * powr<-1>(fma(3., powr<2>(_interp53), fma(3., _cse8 * powr<2>(_interp54), fma(2., 1.732050807568877 * sqrt(_cse13) * _interp41 * _interp54 * _interp55, fma(_cse13, powr<2>(_interp55), 0.))))) * powr<-1>(fma(_cse8, powr<2>(_interp48), fma(2., sqrt(_cse4) * _interp41 * _interp48 * _interp49, fma(_cse4, powr<2>(_interp49), powr<2>(_interp47))))) * powr<-1>(fma(_cse8, powr<2>(_interp51), fma(2., _cse20 * _interp41 * _interp51 * _interp52, fma(_cse7, powr<2>(_interp52), powr<2>(_interp50)))));
                                                    // clang-format on
      }
      return _acc;
    }
