...
(* qcd_setup.m — TEST fixture (sibling of ym_setup.m): the QCD field space (gluon +
   ghost + quark), tensor bases, and dressing rules, ported from
   ~/Documents/Uni/Code/qcd-codes/vacuum/QCD_vacuum_base/QCD.m. This is NOT part of the
   NumTracer frontend — it is the per-theory setup a generator script Gets so it can build
