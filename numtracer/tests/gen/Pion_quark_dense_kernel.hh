...
namespace numtracer_kernels
{
  ...
  class Pion_quark_dense
  {
    ...
    static inline auto kernel(const double& l1, const double& cos1, const double& p, const double& k)
    {
      ...
      constexpr double _tr0_1 = numtracer::dense::contract_all(numtracer::dense::delta_adj<2, 4, 5>(), numtracer::dense::T<2, 4, 7, 8>(), numtracer::dense::delta_fund<2, 6, 7>(), numtracer::dense::delta_fund<2, 8, 9>(), numtracer::dense::delta_fund<2, 11, 6>(), numtracer::dense::delta_fund<2, 10, 11>(), numtracer::dense::T<2, 5, 9, 10>()).scalar_value().re;
      constexpr double _tr0_2 = numtracer::dense::contract_all(numtracer::dense::delta_fund<3, 12, 13>(), numtracer::dense::delta_fund<3, 13, 14>(), numtracer::dense::delta_fund<3, 14, 15>(), numtracer::dense::delta_fund<3, 15, 16>(), numtracer::dense::delta_fund<3, 16, 17>(), numtracer::dense::delta_fund<3, 17, 12>()).scalar_value().re;
      ...
      return 0.6666666666666666 * _den1 * _den2 * _interp3 * _tr0_0 * _tr0_1 * _tr0_2;
    }
...
using numtracer_kernels::Pion_quark_dense;