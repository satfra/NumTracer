...
namespace DiFfRG
{
  class ZA3_num_kernel
  {
    public:
    #if NT_ZA3_NUM_VERDICT == 2   // Pure: the Complex -> Re projection is exact
    // clang-format off
    ...
    // clang-format on
    {
      ...
      const auto _interp15 = ntRe(DiFfRG::za3_num::tr1(fenv));
    ...
    #elif NT_ZA3_NUM_VERDICT == 1   // RePart: real value via complex trace(s), re/im split
    // clang-format off
    static inline auto kernel(const double& l1, const double& cos1, const double& cos2, const double& p, const double& k, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA3, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAcbc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA4, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAqbq1, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Mq)
    // clang-format on
    {
      ...
      const auto _interp25 = Zc(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp26 = Zc(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp27 = ntIm(DiFfRG::za3_num::tr3(fenv));
    ...
    // clang-format on
    {
      ...
      const auto _cse9 = _cse7 + _cse8;
      return fma(-0.005050505050505051, _cse2 * _cse9 * _den2 * _den4 * _den7 * DiFfRG::za3_num::tr0(fenv) * _interp11 * _interp12 * _interp13, fma(-0.005050505050505051, _cse2 * _cse9 * _den2 * _den7 * DiFfRG::za3_num::tr1(fenv) * _interp12 * _interp14, fma(-0.0101010101010101, _cse2 * _den3 * _den5 * _den8 * DiFfRG::za3_num::tr2(fenv) * _interp15 * _interp16 * _interp17 * (_interp1 * _interp18 + (_interp19 + 50. * (-_interp18 + _interp20)) * _interp3), fma(complex<double>(0.,-0.0202020202020202), _cse2 * _den10 * _den6 * _den9 * DiFfRG::za3_num::tr3(fenv) * _interp24 * _interp25 * _interp26 * (-_cse1 * _interp27 * _interp28 - _cse1 * _interp29 * (_interp30 + 50. * (-_interp28 + _interp31))), 0.))));
    }
    #endif
