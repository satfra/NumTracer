...
static inline auto probe_full(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k)
{
  ...
  return fma(-0.0003662109375, _cse2 * _cse9 * _den2 * _den6 * DiFfRG::zaaqbq1_small_num::tr2(fenv) * _interp1 * _interp10, fma(-0.000732421875, _cse2 * _cse9 * _den2 * _den3 * _den6 * DiFfRG::zaaqbq1_small_num::tr1(fenv) * _interp10 * _interp11 * _interp12, fma(complex<double>(0.,0.000732421875), _cse2 * _den5 * _den7 * _den8 * DiFfRG::zaaqbq1_small_num::tr3(fenv) * _interp15 * _interp16 * (-_cse1 * _interp17 * _interp18 - _cse1 * _interp19 * (_interp20 + 50. * (-_interp18 + _interp21))) * _interp28, fma(-0.0003662109375, _cse2 * _cse9 * _den2 * _den3 * _den4 * DiFfRG::zaaqbq1_small_num::tr0(fenv) * _interp11 * _interp29 * _interp32, 0.))));
}
static inline auto probe_proj(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k)
{
  ...
  const auto _interp12 = ntRe(DiFfRG::zaaqbq1_small_num::tr1(fenv));
...
static inline auto probe_repart(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k)
{
  ...
  const auto _interp15 = ntStub(29441., 1. * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const auto _interp16 = ntStub(89189., 1. * powr<2>(k) + 1.618033988749895 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const auto _interp17 = ntIm(DiFfRG::zaaqbq1_small_num::tr3(fenv));
  ...
  const auto _interp32 = ntRe(DiFfRG::zaaqbq1_small_num::tr0(fenv));
