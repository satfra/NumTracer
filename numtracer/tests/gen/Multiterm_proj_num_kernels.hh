// GENERATED by gen_multiterm_proj_num.cpp — do not edit.
#pragma once
#include <cmath>
namespace numtracer_kernels { namespace multiterm_proj_num {
...
}} // namespace numtracer_kernels::multiterm_proj_num
