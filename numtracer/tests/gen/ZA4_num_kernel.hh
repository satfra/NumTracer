...
namespace DiFfRG
{
  ...
  {
    public:
    #if NT_ZA4_NUM_VERDICT == 2   // Pure: the Complex -> Re projection is exact
    // clang-format off
    ...
    #elif NT_ZA4_NUM_VERDICT == 1   // RePart: real value via complex trace(s), re/im split
    // clang-format off
    static inline auto kernel(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA3, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAcbc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA4, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZAqbq1, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zc, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& ZA, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& dtZq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Zq, const SplineInterpolator1D<double, LogarithmicCoordinates1D<double>, GPU_memory>& Mq)
    // clang-format on
    {
    ...
    // clang-format on
    {
      ...
      // clang-format off
      return fma(0.01020408163265306, _den11 * _den12 * _den3 * _den6 * DiFfRG::za4_num::tr4(fenv) * _interp25 * _interp26 * _interp27 * _interp28 * (_interp1 * _interp29 + _interp3 * (_interp30 + 50. * (-_interp29 + _interp31))), fma(0.00510204081632653, _den10 * _den2 * _den4 * _den8 * DiFfRG::za4_num::tr0(fenv) * _interp13 * _interp14 * _interp15 * _interp16 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.00510204081632653, _den10 * _den2 * _den8 * DiFfRG::za4_num::tr1(fenv) * _interp14 * _interp16 * _interp17 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.001275510204081632, _den2 * _den9 * DiFfRG::za4_num::tr3(fenv) * powr<2>(_interp20) * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.002551020408163265, _den10 * _den2 * _den5 * DiFfRG::za4_num::tr2(fenv) * _interp14 * _interp23 * _interp24 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(complex<double>(0.,-0.02040816326530612), _den13 * _den14 * _den15 * _den7 * DiFfRG::za4_num::tr5(fenv) * _interp36 * _interp37 * _interp38 * _interp39 * (-_interp40 * _interp41 * powr<-1>(l1) - _interp42 * (_interp43 + 50. * (-_interp41 + _interp44)) * powr<-1>(l1)), 0.))))));
      // clang-format on
    }
    #endif
